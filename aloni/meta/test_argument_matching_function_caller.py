...
async def handle_command1(arg1: str, arg2: Optional[str] = None) -> str:
    return f"handle_command1 called with arg1={arg1} and arg2={arg2}"


async def handle_command2(arg1: str, arg2: str, arg3: Optional[str] = None) -> str:
    return f"handle_command2 called with arg1={arg1}, arg2={arg2}, and arg3={arg3}"


class TestArgumentMatchingFunctionCaller(unittest.IsolatedAsyncioTestCase):
    async def test_call_function_with_dict_args(self) -> None:
        ...
        result1 = await caller.call_async_function(handle_command1)
        self.assertEqual(
            result1, "handle_command1 called with arg1=value1 and arg2=value2"
        )

        result2 = await caller.call_async_function(handle_command2)
        self.assertEqual(
            result2,
            "handle_command2 called with arg1=value1, arg2=value2, and arg3=None",
        )

    async def test_call_function_with_object_args(self) -> None:
    ...
    async def test_call_function_with_partial_args(self) -> None:
    ...
    async def test_call_function_with_extra_args(self) -> None:
